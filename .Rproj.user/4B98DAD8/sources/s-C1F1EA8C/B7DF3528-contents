...
#' @param theta Vector of study-level point estimates
#' @param theta.sd Vector of study-level standard errors
#' @param mu The effect size to test as the \code{pct}^th percentile
#' @param pct The percentile of interest
#' @param method Estimation method for mean and variance of true effects (passed to \code{metafor::rma.uni})
#' @param nperm Number of simulation iterates to use when estimating null distribution of the test statistic.
#' @references
